...
/*
    // Magento OAuth Authentication API.
    // Register your application to get an API key here:
    //  http://twitter.com/oauth_clients
    'magento' => array(
        'authmagento:Magento',
        'key' => '62bfc45d6d8b315295420305abdb6ad3',
        'secret' => '7cb7f5f5a206dfa4a1faa55710fd1907',
        'target' => 'http://magento19.int',

// $temporaryCredentialsRequestUrl = "http://magento19.int/oauth/initiate?oauth_callback=" . urlencode($callbackUrl);
// $customerAuthorizationUrl = 'http://magento19.int/oauth/authorize';
// $accessTokenRequestUrl = 'http://magento19.int/oauth/token';
// $apiUrl = 'http://magento19.int/api/rest';
