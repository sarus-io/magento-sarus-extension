...
class Swarming_SsoIdp_Model_Config_Idp
{
    const XML_PATH_ENABLED = 'swarming_ssoidp/general/enabled';
    const XML_PATH_ENABLED_SLO = 'swarming_ssoidp/general/enabled_slo';

    const XML_PATH_ENTITY_ID = 'swarming_ssoidp/general/entity_id';

    const XML_PATH_METADATA_URL = 'swarming_ssoidp/general/metadata_url';
    const XML_PATH_SINGLE_SING_ON_URL = 'swarming_ssoidp/general/single_sing_on_url';
    const XML_PATH_SINGLE_LOGOUT_URL = 'swarming_ssoidp/general/single_logout_url';

    const XML_PATH_ALLOWED_SECONDS_SKEW = 'swarming_ssoidp/general/allowed_seconds_skew';


    const XML_PATH_WANT_METADATA_SIGNED = 'swarming_ssoidp/security/metadata_signed';
    const XML_PATH_WANT_AUTHN_SIGNED = 'swarming_ssoidp/security/want_authn_signed';
    const XML_PATH_WANT_LOGOUT_REQUEST_SIGNED = 'swarming_ssoidp/security/want_logout_request_signed';
    const XML_PATH_WANT_LOGOUT_RESPONSE_SIGNED = 'swarming_ssoidp/security/want_logout_response_signed';

    const XML_PATH_ASSERTION_ENCRYPTED = 'swarming_ssoidp/security/assertion_encrypted';
    const XML_PATH_ASSERTION_SIGNED = 'swarming_ssoidp/security/assertion_signed';
    const XML_PATH_MESSAGES_SIGNED = 'swarming_ssoidp/security/messages_signed';

    const XML_PATH_SIGNATURE_ALGORITHM = 'swarming_ssoidp/security/signature_algorithm';
    const XML_PATH_DIGEST_ALGORITHM = 'swarming_ssoidp/security/digest_algorithm';
    const XML_PATH_ENCRYPTED_METHOD_KEY = 'swarming_ssoidp/security/encrypted_method_key';
    const XML_PATH_ENCRYPTED_METHOD_DATA = 'swarming_ssoidp/security/encrypted_method_data';

    const XML_PATH_PRIVATE_KEY = 'swarming_ssoidp/credentials/private_key';
    const XML_PATH_CERT = 'swarming_ssoidp/credentials/cert';

    const XML_PATH_TECHNICAL_CONTACT_GIVEN_NAME = 'swarming_ssoidp/contact/technical_contact_given_name';
    const XML_PATH_TECHNICAL_CONTACT_EMAIL = 'swarming_ssoidp/contact/technical_contact_email';

    const XML_PATH_SUPPORT_CONTACT_GIVEN_NAME = 'swarming_ssoidp/contact/support_contact_given_name';
    const XML_PATH_SUPPORT_CONTACT_EMAIL = 'swarming_ssoidp/contact/support_contact_email';

    /**
     * @var Swarming_SsoIdp_Helper_Data
     */
    protected $_helper;

    public function __construct()
    {
        $this->_helper = Mage::helper('swarming_ssoidp');
    }
