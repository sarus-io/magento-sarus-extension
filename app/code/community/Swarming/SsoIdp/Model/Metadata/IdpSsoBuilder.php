...
class Swarming_SsoIdp_Model_Metadata_IdpSsoBuilder
{
    /**
    ...
    /**
     * @var Swarming_SsoIdp_Helper_IdpEncryptionCredentials
     */
    protected $_idpEncryptionCredentials;

    public function __construct()
    {
        $this->_configIdp = Mage::getModel('swarming_ssoidp/config_idp');
        $this->_idpCredentials = Mage::helper('swarming_ssoidp/idpCredentials');
    }
