...
class Swarming_SsoIdp_IdpController extends Mage_Core_Controller_Front_Action
{
    /**
    ...
    /**
     * @var \Swarming_SsoIdp_Model_AuthnRequestValidator
     */
    protected $_authnRequestValidator;

    /**
     * @var Swarming_SsoIdp_Model_AuthnResponseBuilder
     */
    protected $_authnResponseBuilder;

    /**
     * @var Swarming_SsoIdp_Model_LogoutRequestValidator
     */
    protected $_logoutRequestValidator;

    /**
     * @var Swarming_SsoIdp_Model_LogoutResponseBuilder
     */
    protected $_logoutResponseBuilder;

    /**
     * @var Swarming_SsoIdp_Model_LogoutResponseValidator
     */
    protected $_logoutResponseValidator;

    /**
     * @var Swarming_SsoIdp_Model_MetadataBuilder
     */
    protected $_metadataBuilder;

    /**
     * @var Swarming_SsoIdp_Model_Serializer
     */
    ...
    protected function _construct()
    {
        ...
        $this->_authnRequestValidator = Mage::getModel('swarming_ssoidp/authnRequestValidator');
        $this->_authnResponseBuilder = Mage::getModel('swarming_ssoidp/authnResponseBuilder');

        $this->_logoutRequestValidator = Mage::getModel('swarming_ssoidp/logoutRequestValidator');
        $this->_logoutResponseBuilder = Mage::getModel('swarming_ssoidp/logoutResponseBuilder');

        $this->_logoutResponseValidator = Mage::getModel('swarming_ssoidp/logoutResponseValidator');

        $this->_metadataBuilder = Mage::getModel('swarming_ssoidp/metadataBuilder');

        $this->_serializer = Mage::getModel('swarming_ssoidp/serializer');
    ...
    public function loginAction()
    {
        ...
        /** @var Swarming_SsoIdp_Block_Login $block */
    ...
    {
        try {
            $requestId = $this->_getSsoSession()->getData(Swarming_SsoIdp_Helper_Data::LOGOUT_REQUEST_ID);
